...
public class spiqLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IS", "SIGN", "PLUS", "MINUS", "SLASH", "DOT", "EXP", "A", "AN", "INTEGER", 
			"NUMBER", "FRACTION", "RATIONAL", "REAL", "DIGIT", "ID", "WHITESP", "ERR"
		};
	}
	...
	public spiqLexer(CharStream input) {
		super(input);
